...
L.Control.Measure = L.Control.extend({
  ...
  options: {
    ...
    activeColor: '#3849c9', // base color for map features while actively measuring
    completedColor: '#b9bef0', // base color for permenant features generated from completed measure
    lineColor: 'blue',
